...
var Sidebar = function Sidebar(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("div", {
    ...
    className: "absolute top-0 right-0 bottom-0 w-full bg-white py-12 md:py-16 px-4",
    style: {
    ...
    className: "py-2 max-h-full overflow-y-scroll"
  }, __jsx("div", {
    onClick: function onClick() {
    ...
    className: "flex items-center pb-2 max-h-full overflow-y-scroll border-solid border-b border-gray-300"
  }, __jsx("div", {
    className: "w-1/3",
    onClick: function onClick() {
      return back();
    ...
    className: "text-xl text-gray-800 font-semibold capitalize"
    ...
    className: "text-lg text-gray-900 font-semibold capitalize"
    ...
    className: "overflow-y-scroll max-h-full py-2 max-h-full overflow-y-scroll"
...
//# sourceMappingURL=dash.js.42378df8ef0145acab57.hot-update.js.map