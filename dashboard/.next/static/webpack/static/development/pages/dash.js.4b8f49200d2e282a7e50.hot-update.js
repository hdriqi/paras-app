...
var Sidebar = function Sidebar(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("div", {
    ...
    className: "absolute top-0 right-0 bottom-0 w-64 bg-white px-4",
    style: {
    ...
    className: ""
  }, "Customize your data")), __jsx("div", null, __jsx("div", {
    onClick: function onClick() {
      return setShowNestedSidebar('profile');
    },
    className: "h-12 flex items-center justify-between border-solid border-b border-t border-gray-300"
  }, __jsx("p", {
    className: "text-gray-700 w-1/2 font-medium"
  }, "Profile "), __jsx("svg", {
    width: "16",
    height: "16",
    viewBox: "0 0 16 16",
    ...
    className: "h-12 flex items-center justify-between border-solid border-b border-gray-300"
  }, __jsx("p", {
...
//# sourceMappingURL=dash.js.4b8f49200d2e282a7e50.hot-update.js.map