...
var Sidebar = function Sidebar(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("div", {
    className: "fixed top-0 right-0 bottom-0 w-10/12 md:w-5/12 lg:w-3/12 bg-white shadow-xl",
    style: {
    ...
    className: "absolute top-0 right-0 bottom-0 w-10/12 md:w-5/12 lg:w-3/12 bg-white px-4",
    style: {
      transform: "translate3d(".concat(showNestedSidebar ? 0 : "100%", ", 0, 0)"),
      transition: "all .3s"
    }
...
//# sourceMappingURL=dash.js.47512f86bac9f6381c5d.hot-update.js.map