...
var Sidebar = function Sidebar(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, __jsx("div", {
    className: "fixed top-0 right-0 bottom-0 w-9/12 md:w-3/12 bg-white shadow-xl",
    style: {
    ...
    className: "absolute top-0 right-0 bottom-0 w-9/12 md:w-3/12 bg-white px-4",
    style: {
      transform: "translate3d(".concat(showNestedSidebar ? 0 : "100%", ", 0, 0)"),
      transition: "all .3s"
    }
...
//# sourceMappingURL=dash.js.f49ade7012e12d5e5bb8.hot-update.js.map