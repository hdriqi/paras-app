...
const AvailablePage = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Address is Available | Paras</title>
      </Head>
				...
				<div className="flex w-full h-full items-center justify-center">
					<div className="login text-center">
						<div className="mb-16">
							...
							<p className="text-3xl text-gray-900 font-semibold">Address is Available!</p>
							<p className="text-lg text-gray-600 font-medium">Get your own personal website in a minute</p>
						</div>
						<a href={`${process.env.APP_DOMAIN}/login`}>
							<button className="text-lg font-medium bg-gray-900 text-white border-solid border-2 rounded-lg border-gray-900 px-4 py-1">
								Create My Paras
							</button>
						</a>
					</div>
