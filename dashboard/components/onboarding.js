												...
												<div className="border-solid border rounded-sm border-gray-300" style={{
													...
													<div className="h-full w-full flex items-center justify-center" style={{
														...
														<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															...
															<input className="absolute cursor-pointer inset-0 opacity-0 w-full" onClick={(e) => e.target.value = null} type="file" accept="image/*" onChange={(e) => updateAvatarUrl(e.target.files)} />
														</div>
													</div>
												</div>
											</div>
